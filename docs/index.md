...
- **Stripe SPT adapter wiring.** UCP can bind SPTs into AP2 payment mandates;
  ACP can send direct SPT `payment_data`; release validation uses mock Stripe
  until real Stripe business-profile/SPT access is available.
...
v0.6.0. MIT. Pinned to the published versions of each protocol spec (ACP
