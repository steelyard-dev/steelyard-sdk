...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: "steelyard/protocol/acp/checkout", replacement: source("../../packages/protocol/src/acp/checkout.ts") },
      ...
      { find: "steelyard/protocol/ucp/checkout", replacement: source("../../packages/protocol/src/ucp/checkout.ts") },
